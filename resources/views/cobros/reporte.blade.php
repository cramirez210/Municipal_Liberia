...
<div class="col-md-6 float-right">
              ...
              <div class="col-md-15 mt-3">
                <b>Cobros realizados:</b> 
                 {{$reporte['total_cobros']}}
                  <div>
                    <a href="/cobros/user/{{$reporte['user']->user_id}}">Ver cobros realizados</a>
                  </div>
              </div>
              ...
              <div class="col-md-15 mt-3">
                ...
                <div>
                    <a href="/cobros/list/{{$reporte['user']->user_id}}/4">Ver cobros liquidados</a>
                  </div>
              </div>
              ...
              <div class="col-md-15 mt-3">
                ...
                <div>
                    <a href="/cobros/list/{{$reporte['user']->user_id}}/3">Ver pendientes de liquidar</a>
                  </div>
              </div>
</div>
