...
<div id="buscar_comisiones_fechas_user" class="modal fade" role="dialog">
  ...
  <form class="form col-md-12" method="POST" action="/reportes/comisiones/fechas/user" target="_blank"> 
    {{ csrf_field() }}
